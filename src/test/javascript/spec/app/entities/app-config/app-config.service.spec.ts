...
describe('Service Tests', () => {
  describe('AppConfig Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new AppConfig(0, 0, 0, 0, 0, 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a AppConfig', () => {
        const returnedFromService = Object.assign(
          {
            criticalWordsMaxFileSize: 1,
            criticalWordsMaxWords: 1,
            additionalContextMaxFileSize: 1,
            additionalContextMaxFileWords: 1,
            minOccurencyContext: 1,
            windowsMaxWords: 1
          },
          elemDefault
        );
